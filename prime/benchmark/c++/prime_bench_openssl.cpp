...
// g++ prime_bench_openssl.cpp -o prime_bench_openssl -lcrypto -lbenchmark -lbenchmark_main -pthread

// > ./prime_bench_openssl --benchmark_min_time=30

// > ./prime_bench_openssl --benchmark_repetitions=100